...
public class SpatialHashGrid {
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int)FloatMath.floor(obj.bounds.center.x / cellSize);
        int y1 = (int)FloatMath.floor(obj.bounds.center.y / cellSize);
        int x2 = (int)FloatMath.floor((obj.bounds.center.x + obj.bounds.radius) / cellSize);
        int y2 = (int)FloatMath.floor((obj.bounds.center.y + obj.bounds.radius) / cellSize);
